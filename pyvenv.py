...
Adition=Button(cal,padx=16,bd=8, fg="black",font=('arial', 20,'bold'),
...
#============================================================================
btn0=Button(cal,padx=16,bd=8,pady=19, fg="black",font=('arial', 20,'bold'),
     text="0",command=lambda:btnClick(0),bg="light blue").grid(row=4,column=0)

btnClear=Button(cal,padx=16,bd=8,pady=19, fg="black",font=('arial', 20,'bold'),
     text="C", bg="light blue",command=btnClearDisplay).grid(row=4,column=1)

btnEquals=Button(cal,padx=16,pady=19,bd=8, fg="black",font=('arial', 20,'bold'),
     text="=", bg="light blue",command=btnEqualsInput) .grid(row=4,column=2)

Division=Button(cal,padx=19,pady=19,bd=8, fg="black",font=('arial', 20,'bold'),
